...
-- Copiando dados para a tabela produtos_de_limpeza.cadastro_produtos: ~6 rows (aproximadamente)
INSERT INTO `cadastro_produtos` (`id_produto`, `nome`, `marca`, `volume`, `tipo_embalagem`, `aplicacao`, `estoque`, `estoque_minimo`) VALUES
	...
	(4, 'Hipoclorito de Sódio', 'Asfer', '1L', 'Plástico', 'Hospitalar', 10, 2),
	(5, 'Desinfetante Hospitalar', 'Optigerm', '750ml', 'Plástico', 'Hospitalar', 15, 5),
	(6, 'Sabonete', 'Dove', '90g', 'Papel', 'Doméstica', 20, 10);
